...
function errormap(dirin::String, sensornum, distRBF, xyzc=missing)  #xyzc added as argument, 2019/8/5
  b = Block(dirin, sensornum)
  #block_show(b)
  if ismissing(xyzc)
    xyzc = P1getDataSX(sensornum, dirin, "Cal32out.dat", ZOFFSET(), distRBF)  #input as argument, 2019/8/5
  end
